...
describe 'pconv.util', ->
  ...
  describe '#prop() for getting deep properties', ->
    ...
    it 'should correctly get deep basic property values', ->
      ...
      expect(pconv.util.prop test, 'c.z').to.be.undefined()
